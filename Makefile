...
CFLAGS = -Wall -O3
CPPFLAGS = -I. $(shell pkg-config --cflags $(packages))
LDFLAGS = -lm -lassimp -lSDL2_image -lSDL2 -lSDL2_mixer -lSDL2_ttf

packages = glfw3 glew
LIBS := $(shell pkg-config --static --libs $(packages))

# définition des fichiers et dossiers
PROGNAME = sample-projet-vle-jeune
VERSION = 0.4
...
$(PROGNAME): $(OBJ)
	$(CC) $(OBJ) $(LDFLAGS) -o $(PROGNAME) $(LIBS)
